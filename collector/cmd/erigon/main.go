...
import (
	...
	verdiffCollectorslot "github.com/ledgerwatch/erigon/verdiffCollector-slot"
)
...
func runErigon(cliCtx *cli.Context) error {
	...
	// * verdiffCollector - slot log starter
	common.GlobalSlotWatcher = verdiffCollectorslot.NewSWatcher()
